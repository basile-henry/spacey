...
var author$project$Main$parseReturn = _Platform_incomingPort('parseReturn', elm$json$Json$Decode$value);
...
var author$project$Main$subscriptions = function (model) {
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				author$project$Main$subPort(author$project$Main$Receive),
				author$project$Main$parseReturn(author$project$Main$Process)
			]));
};
